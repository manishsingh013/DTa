...
I am **Movie Find Bot**.I am best Movie Link Search Bot! 
I Will search your channel movies automatically and send it in your group chat when Someone search it."""

    HELP = """To Use me In A Group

- Add me in your group & channel with all permissions. 
- Send /verify in group & wait for It To Accept Or Directly Contact To Owner After Request @manishsingh13.
...
Get connected channels list with - /connections"""
    ...
    ABOUT = """Powered By @manishsingh13

✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='tg://user?id=1727021749'>Manish</a>
