...
async def search(bot, message):
    ...
    if message.text.startswith("/"):
       return    
    query   = message.text 
    head    = "<u>Here is the results 👇\n\nPowered By </u> <b><I>@manishsingh13</I></b>\n\n"
    results = ""
    try:
       ...
       if bool(results)==False:
          ...
          msg = await message.reply_photo(photo="https://telegra.ph/file/e0b4f9d599c75cfb2857d.jpg",
                                          caption="<b><I>I Couldn't find anything related to Your Query😕 Report to admin @manishsingh13.\nDid you mean any of these?</I></b>", 
